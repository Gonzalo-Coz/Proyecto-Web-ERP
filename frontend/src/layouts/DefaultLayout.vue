...
const MENU: { section: string; items: MenuItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'dispatch-guides', label: 'Guías de Remisión', permission: null, icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zm10 0a2 2 0 11-4 0 2 2 0 014 0zM3 4h11v10H3V4zm11 3h4l3 3v4h-7V7z' },
